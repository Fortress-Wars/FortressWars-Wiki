...
- Increased regeneration effect's duration from **160** ticks to **240** ticks.
- Increased resistance effect's duration from **160** ticks to **240** ticks.
...
- Decreased anvil cooldown from **140** ticks to **80** ticks.
- Increased anvil direct damage from **10** to **12**.
- Increased anvil direct impact radius from **1** meter to **1.5** meters.
...
- Decreased max triggers from **2** to **1**.
...
- Decreased lightning damage from **12** to **10**.
...
- Standardized all **Damage, Support, Utility** kits armor pieces to have protection level **1**.
- Standardized all **Tank** kits armor pieces to have protection level **4**.
...
- Overtime in the Classic Gamemode now triggers when the beacons' health changes from **1%** to **0%** instead of from **2%** to **1%**.
...
- Fixed inconsistencies with Gamemode state clocks.
